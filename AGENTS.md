...
|selvedge.cli.login_chatgpt|selvedge.cli.login_chatgpt.{executor,parse,progress}
|selvedge.cli.login_chatgpt.executor|selvedge.cli.login_chatgpt.executor.{failure}
|selvedge.cli.login_chatgpt.progress|selvedge.cli.login_chatgpt.progress.{closed,diagnostic_closed}
...
|selvedge.startup.server.local_operation|selvedge.startup.server.local_operation.{cancellation_registry,command,executor,executor_ref,executor_trait,failure,future,login,notice,progress,progress_sender,success,task}
