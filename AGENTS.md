...
|req.api|req.api.{diagnostic,mode,module,parse,record,report,status,tag}
|req.api.diagnostic|req.api.diagnostic.{line,macro,message,path,rule}
|req.api.diagnostic.line|req.api.diagnostic.line.{}
|req.api.diagnostic.macro|req.api.diagnostic.macro.{}
|req.api.diagnostic.message|req.api.diagnostic.message.{}
|req.api.diagnostic.path|req.api.diagnostic.path.{}
|req.api.diagnostic.rule|req.api.diagnostic.rule.{}
|req.api.mode|req.api.mode.{}
|req.api.module|req.api.module.{}
|req.api.parse|req.api.parse.{id_grammar,id_presence,sentence_count,sentence_presence,tag}
|req.api.parse.id_grammar|req.api.parse.id_grammar.{}
|req.api.parse.id_presence|req.api.parse.id_presence.{}
|req.api.parse.sentence_count|req.api.parse.sentence_count.{}
|req.api.parse.sentence_presence|req.api.parse.sentence_presence.{}
|req.api.parse.tag|req.api.parse.tag.{}
|req.api.record|req.api.record.{binding,id,line,path,sentence,tag,test_context}
|req.api.record.binding|req.api.record.binding.{}
|req.api.record.id|req.api.record.id.{}
|req.api.record.line|req.api.record.line.{}
|req.api.record.path|req.api.record.path.{}
|req.api.record.sentence|req.api.record.sentence.{}
|req.api.record.tag|req.api.record.tag.{}
|req.api.record.test_context|req.api.record.test_context.{}
|req.api.report|req.api.report.{declarations,diagnostics,verifications}
|req.api.report.declarations|req.api.report.declarations.{}
|req.api.report.diagnostics|req.api.report.diagnostics.{}
|req.api.report.verifications|req.api.report.verifications.{}
...
|req.check.registry|req.check.registry.{ancestor,target_declaration,target_kind,test_path}
|req.check.registry.ancestor|req.check.registry.ancestor.{}
|req.check.registry.target_declaration|req.check.registry.target_declaration.{}
|req.check.registry.target_kind|req.check.registry.target_kind.{}
|req.check.registry.test_path|req.check.registry.test_path.{}
|req.check.snapshot|req.check.snapshot.{staged_read,worktree_invalid,worktree_read}
|req.check.snapshot.staged_read|req.check.snapshot.staged_read.{}
|req.check.snapshot.worktree_invalid|req.check.snapshot.worktree_invalid.{}
|req.check.snapshot.worktree_read|req.check.snapshot.worktree_read.{}
|req.cli|req.cli.{all_error,base_error,base_ref,format_error,scan_error,staged_error}
|req.cli.all_error|req.cli.all_error.{}
|req.cli.base_error|req.cli.base_error.{}
|req.cli.base_ref|req.cli.base_ref.{}
...
|req.detector.diff|req.detector.diff.{}
...
|req.detector.structure|req.detector.structure.{trait_object}
|req.detector.structure.trait_object|req.detector.structure.trait_object.{}
|req.format|req.format.{index_block,read,write}
|req.format.index_block|req.format.index_block.{marker_balance,marker_count,marker_lookup_begin,marker_lookup_end}
|req.format.index_block.marker_balance|req.format.index_block.marker_balance.{}
|req.format.index_block.marker_count|req.format.index_block.marker_count.{}
|req.format.index_block.marker_lookup_begin|req.format.index_block.marker_lookup_begin.{}
|req.format.index_block.marker_lookup_end|req.format.index_block.marker_lookup_end.{}
|req.format.read|req.format.read.{}
|req.format.write|req.format.write.{}
|req.scan|req.scan.{parse_error}
|req.scan.parse_error|req.scan.parse_error.{}
