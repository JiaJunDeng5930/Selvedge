...
|selvedge.startup.server.local_operation|selvedge.startup.server.local_operation.{command,executor,executor_ref,executor_trait,failure,future,login,notice,progress,progress_sender,success,task}
