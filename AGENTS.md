...
|selvedge.login.auth_file.lock|selvedge.login.auth_file.lock.{lifetime}
...
|selvedge.model.dispatch|selvedge.model.dispatch.{adapter,bytes,input,outcome,provider,provider_config,reply,run,spawn,success,timeout,unknown_provider}
